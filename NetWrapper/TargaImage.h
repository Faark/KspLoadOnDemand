...
namespace Paloma
{
	...
	public:
		...
		static const int HeaderByteLength = 18;
		static const int FooterByteLength = 26;
		static const int FooterSignatureOffsetFromEnd = 18;
		static const int FooterSignatureByteLength = 16;
		static const int FooterReservedCharByteLength = 1;
		static const int ExtensionAreaAuthorNameByteLength = 41;
		static const int ExtensionAreaAuthorCommentsByteLength = 324;
		static const int ExtensionAreaJobNameByteLength = 41;
		static const int ExtensionAreaSoftwareIDByteLength = 41;
		static const int ExtensionAreaSoftwareVersionLetterByteLength = 1;
		static const int ExtensionAreaColorCorrectionTableValueLength = 256;
		static String^ TargaFooterASCIISignature = "TRUEVISION-XFILE";
	};
	...
	/// </summary>
	enum class VerticalTransferOrder
	{
		/// <summary>
	...
	/// </summary>
	enum class HorizontalTransferOrder
	{
		/// <summary>
		/// Unknown transfer order.
		/// </summary>
	...
	/// </summary>
	enum class FirstPixelDestination
	{
		/// <summary>
	...
	internal:
		...
		/// </remarks>
		static String^ GetIntBinaryString(Int32 n)
		{
			auto b = gcnew array<Char>(32);
			int pos = 31;
			int i = 0;
		...
		/// This method was used during debugging and is left here just for fun.
		/// </remarks>
		static String^ GetInt16BinaryString(Int16 n)
		{
			auto b = gcnew array<Char>(16);
			int pos = 15;
			int i = 0;
	...
	internal:
		...
		/// </summary>
	public: property ColorMapType ColorMapTypeProperty
	{
		ColorMapType get(){ return eColorMapType; }
	}
	...
	internal:
		void SetColorMapType(ColorMapType eColorMapType)
		{
		...
		/// </summary>
	public:
		property ImageType ImageTypeProperty
		{
			ImageType get(){ return this->eImageType; }
		}
	...
	internal:
		void SetImageType(ImageType eImageType)
		{
		...
		/// </summary>
	public:
		property short ColorMapFirstEntryIndex
		{
			short get(){ return this->sColorMapFirstEntryIndex; }
		}
	...
	internal:
		void SetColorMapFirstEntryIndex(short sColorMapFirstEntryIndex)
		{
		...
		/// </summary>
	public:
		property short ColorMapLength
		{
			short get(){ return this->sColorMapLength; }
		}
	...
	internal: void SetColorMapLength(short sColorMapLength)
	{
	...
	internal:
		...
		/// </summary>
	public:
		property short XOrigin
		{
			short get(){ return this->sXOrigin; }
		}
	...
	internal:
		void SetXOrigin(short sXOrigin)
		{
		...
		/// </summary>
	public:
		property short YOrigin
		{
			short get(){ return this->sYOrigin; }
		}
	...
	internal: void SetYOrigin(short sYOrigin)
	{
	...
	internal:
		...
		/// </summary>
	public:
		property FirstPixelDestination FirstPixelDestinationProperty
		{
			FirstPixelDestination get()
			{
		...
		/// </summary>
	public:
		property VerticalTransferOrder VerticalTransferOrderProperty
		{
			VerticalTransferOrder get(){ return this->eVerticalTransferOrder; }
		}
	...
	internal:
		void SetVerticalTransferOrder(VerticalTransferOrder eVerticalTransferOrder)
		{
		...
		/// </summary>
	public:
		property HorizontalTransferOrder HorizontalTransferOrderProperty
		{
			HorizontalTransferOrder get(){ return this->eHorizontalTransferOrder; }
		}
	...
	internal:
		void SetHorizontalTransferOrder(HorizontalTransferOrder eHorizontalTransferOrder)
		{
	...
	internal:
		...
		/// </summary>
	public:
		property String^ ImageIDValue
		{
			String^ get(){ return this->strImageIDValue; }
		}
	...
	internal:
		void SetImageIDValue(String^ strImageIDValue)
		{
		...
		/// </summary>
	public:
		property List<System::Drawing::Color>^ ColorMap
		{
			List<System::Drawing::Color>^ get(){ return this->cColorMap; }
		}
	...
	/// </summary>
	public ref class TargaExtensionArea
	{
	private:
		static DateTime currentData(){
			return DateTime::Now;
		}
		...
		DateTime dtDateTimeStamp = currentData();
		...
		List<int>^ intScanLineTable = gcnew List<int>();
		List<System::Drawing::Color>^ cColorCorrectionTable = gcnew List<System::Drawing::Color>();
		...
		/// </summary>
	public:
		property int ExtensionSize
		{
			int get(){ return this->intExtensionSize; }
		}
	...
	internal:
		void SetExtensionSize(int intExtensionSize)
		{
	...
	public:
		...
		{
			String^ get(){ return this->strAuthorName; }
		}
	...
	internal: void SetAuthorName(String^ strAuthorName)
	{
		this->strAuthorName = strAuthorName;
			  ...
			  /// </summary>
	public:
		property String^ AuthorComments
		{
			String^ get(){ return this->strAuthorComments; }
		}
	...
	internal:
		void SetAuthorComments(String^ strAuthorComments)
		{
	...
	public:
		...
		{
			DateTime get(){ return this->dtDateTimeStamp; }
		}
	...
	internal:
		void SetDateTimeStamp(DateTime dtDateTimeStamp)
		{
	...
	public:
		...
		{
			String^ get(){ return this->strJobName; }
		}
	...
	internal:
		...
		/// </summary>
	public:
		property TimeSpan JobTime
		{
			TimeSpan get(){ return this->dtJobTime; }
		}
	...
	internal:
		void SetJobTime(TimeSpan dtJobTime)
		{
	...
	public:
		...
		{
			String^ get(){ return this->strSoftwareID; }
		}
	...
	internal:
		void SetSoftwareID(String^ strSoftwareID)
		{
	...
	public:
		...
		{
			String^get(){ return this->strSoftwareVersion; }
		}
	...
	internal:
		void SetSoftwareVersion(String^ strSoftwareVersion)
		{
	...
	public:
		...
		{
			Color get(){ return this->cKeyColor; }
		}
	...
	internal:
		void SetKeyColor(Color cKeyColor)
		{
		...
		/// </summary>
	public:
		property int PixelAspectRatioNumerator
		{
			int get(){ return this->intPixelAspectRatioNumerator; }
		}
	...
	internal:
		void SetPixelAspectRatioNumerator(int intPixelAspectRatioNumerator)
		{
		...
		/// </summary>
	public:
		property int PixelAspectRatioDenominator
		{
			int get(){ return this->intPixelAspectRatioDenominator; }
		}
	...
	internal:
		void SetPixelAspectRatioDenominator(int intPixelAspectRatioDenominator)
		{
	...
	public:
		...
		/// </summary>
	public:
		property int GammaNumerator
		{
			int get(){ return this->intGammaNumerator; }
		}
	...
	internal:
		void SetGammaNumerator(int intGammaNumerator)
		{
		...
		/// </summary>
	public:
		property int GammaDenominator
		{
			int get(){ return this->intGammaDenominator; }
		}
	...
	internal:
		void SetGammaDenominator(int intGammaDenominator)
		{
	...
	public:
		...
		/// </summary>
	public:
		property int ColorCorrectionOffset
		{
			int get(){ return this->intColorCorrectionOffset; }
		}
	...
	internal:
		void SetColorCorrectionOffset(int intColorCorrectionOffset)
		{
		...
		/// </summary>
	public:
		property int PostageStampOffset
		{
			int get(){ return this->intPostageStampOffset; }
		}
	...
	internal:
		void SetPostageStampOffset(int intPostageStampOffset)
		{
		...
		/// </summary>
	public:
		property int ScanLineOffset
		{
			int get(){ return this->intScanLineOffset; }
		}
	...
	internal:
		void SetScanLineOffset(int intScanLineOffset)
		{
		...
		/// </summary>
	public:
		property int AttributesType
		{
			int get(){ return this->intAttributesType; }
		}
	...
	internal:
		void SetAttributesType(int intAttributesType)
		{
		...
		/// </summary>
	public:
		property List<int>^ ScanLineTable
		{
			List<int>^get(){ return this->intScanLineTable; }
		}
		...
		/// </summary>
	public:
		property List<System::Drawing::Color>^ ColorCorrectionTable
		{
			List<System::Drawing::Color>^ get(){ return this->cColorCorrectionTable; }
		}
	};
	...
	/// </summary>
	public ref class TargaFooter
	{
	private:
		int intExtensionAreaOffset = 0;
		int intDeveloperDirectoryOffset = 0;
		String^ strSignature = String::Empty;
		String^ strReservedCharacter = String::Empty;
		...
		/// </summary>
	public:
		property int ExtensionAreaOffset
		{
			int get(){ return this->intExtensionAreaOffset; }
		}
	...
	internal:
		void SetExtensionAreaOffset(int intExtensionAreaOffset)
		{
		...
		/// </summary>
	public:
		property int DeveloperDirectoryOffset
		{
			int get(){ return this->intDeveloperDirectoryOffset; }
		}
	...
	internal:
		void SetDeveloperDirectoryOffset(int intDeveloperDirectoryOffset)
		{
	...
	public:
		...
		{
			String^get(){ return this->strSignature; }
		}
	...
	internal:
		void SetSignature(String^ strSignature)
		{
		...
		/// </summary>
	public:
		property String ^ReservedCharacter
		{
			String^ get(){ return this->strReservedCharacter; }
		}
	...
	internal:
		void SetReservedCharacter(String^ strReservedCharacter)
		{
	...
	/// </summary>
	public ref class TargaImage : IDisposable
	{
	private:
		TargaHeader^ objTargaHeader = nullptr;
		TargaExtensionArea^ objTargaExtensionArea = nullptr;
		TargaFooter^ objTargaFooter = nullptr;
		Bitmap^ bmpTargaImage = nullptr;
		Bitmap^ bmpImageThumbnail = nullptr;
		TGAFormat eTGAFormat = TGAFormat::UNKNOWN;
	...
	public:
		TargaImage()
		{
			this->objTargaFooter = gcnew TargaFooter();
			this->objTargaHeader = gcnew TargaHeader();
			this->objTargaExtensionArea = gcnew TargaExtensionArea();
			this->bmpTargaImage = nullptr;
			this->bmpImageThumbnail = nullptr;
		}
		...
		/// </summary>
		property TargaHeader^ Header
		{
			TargaHeader^ get(){ return this->objTargaHeader; }
		}
		...
		/// </summary>
		property TargaExtensionArea^ ExtensionArea
		{
			TargaExtensionArea^ get(){ return this->objTargaExtensionArea; }
		}
		...
		/// </summary>
		property TargaFooter^ Footer
		{
			TargaFooter^get(){ return this->objTargaFooter; }
		}
		...
		/// </summary>
		property TGAFormat Format
		{
			TGAFormat get(){ return this->eTGAFormat; }
		}
		...
		{
			Bitmap^ get(){ return this->bmpTargaImage; }
		}
		...
		{
			Bitmap^get(){ return this->bmpImageThumbnail; }
		}
		...
		{
			int get(){ return this->intPadding; }
		}
		...
		void LoadTGAFromFile(String^ file){
			...
			if (Path::GetExtension(strFileName)->ToLower() == "->tga")
			{
				...
				if (File::Exists(strFileName) == true)
				{
					...
					if (filebytes != nullptr && filebytes->Length > 0)
					{
	...
	private:
			...
			if (binReader != nullptr && binReader->BaseStream != nullptr && binReader->BaseStream->Length > 0 && binReader->BaseStream->CanSeek == true)
			{
				...
				if (this->objTargaFooter->ExtensionAreaOffset > 0)
				{
					try
					{
						...
						if (DateTime::TryParse(strStamp, dtstamp) == true)
						...
						TimeSpan ts = TimeSpan((int)iHour, (int)iMinute, (int)iSecond);
		...
		array<byte>^ LoadImageBytes(BinaryReader^ binReader)
		{
			...
			if (binReader != nullptr && binReader->BaseStream != nullptr && binReader->BaseStream->Length > 0 && binReader->BaseStream->CanSeek == true)
			{
				if (this->objTargaHeader->ImageDataOffset > 0)
				{
					...
					if (this->objTargaHeader->ImageTypeProperty == ImageType::RUN_LENGTH_ENCODED_BLACK_AND_WHITE ||
						this->objTargaHeader->ImageTypeProperty == ImageType::RUN_LENGTH_ENCODED_COLOR_MAPPED ||
						this->objTargaHeader->ImageTypeProperty == ImageType::RUN_LENGTH_ENCODED_TRUE_COLOR)
					{
		...
		void LoadTGAImage(BinaryReader^ binReader)
		{
			...
			if (this->bmpImageThumbnail != nullptr)
			{
				delete this->bmpImageThumbnail;
			}
			...
			if (this->objTargaHeader->ColorMap->Count > 0)
			{
				...
				// set the gcnew palette back to the Bitmap object
			...
			{ // no color map
				...
				if (this->objTargaHeader->PixelDepth == 8 && (this->objTargaHeader->ImageTypeProperty == ImageType::UNCOMPRESSED_BLACK_AND_WHITE ||
					this->objTargaHeader->ImageTypeProperty == ImageType::RUN_LENGTH_ENCODED_BLACK_AND_WHITE))
				{
			...
			if (binReader != nullptr && binReader->BaseStream != nullptr && binReader->BaseStream->Length > 0 && binReader->BaseStream->CanSeek == true)
			{
				if (this->ExtensionArea->PostageStampOffset > 0)
				{
					...
					if (data != nullptr && data->Length > 0)
					{
						...
						this->bmpImageThumbnail = gcnew Bitmap(iWidth, iHeight, iStride, pfPixelFormat,
